...
const UserProfile = () => {
  const [checkChangePass, setCheckChanglePass] = useState<boolean>(false)
          ...
          <div className='relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-xl rounded-lg -mt-64'>
            <div className='px-6'>
              <div className='flex flex-wrap justify-center'>
                    ...
                    <div className='py-6 px-3 mt-32 sm:mt-0 float-right'>
                      <Tooltip placement='top' title={'Quay Lại Trang Cá Nhân !'}>
                        <Button
                          ...
                          type='button'
                          onClick={() => setCheckChanglePass(false)}
                        >
                          Quay Về
                          <PiKeyReturnFill />
                        </Button>
                ...
                <div className='w-full  lg:w-4/12  lg:order-1'>
                  <Form className='items-center'>
                    <Form.Item  name='code' className='mt-5'>
                      <Input disabled className='' size='large' placeholder={'dmvn 972524'} prefix={<UserOutlined />} />
                    </Form.Item>
                    <Form.Item  name='code' className='mt-5'>
                      <Button onClick={() => setCheckChanglePass(true)} styleClass='bg-secondary'>
                        Đổi Mật Khẩu
                      </Button>
                    </Form.Item>
                  </Form>
